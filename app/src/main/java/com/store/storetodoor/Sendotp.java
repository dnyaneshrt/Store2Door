...
public class Sendotp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entercode = (EditText) findViewById(R.id.phoneno_edittext_so);
        txt = (TextView) findViewById(R.id.text_so);
        Resend = (Button) findViewById(R.id.Resendotp_button_so);

        FAuth = FirebaseAuth.getInstance();
        Resend.setVisibility(View.INVISIBLE);
        txt.setVisibility(View.INVISIBLE);

        verify = (Button) findViewById(R.id.Verify_button_so);
