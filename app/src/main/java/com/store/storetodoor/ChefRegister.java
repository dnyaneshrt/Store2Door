...
public class ChefRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Mumbai")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegister.this, android.R.layout.simple_spinner_item, listt);
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    dialog.dismiss();
                                                                  //  Toast.makeText(ChefRegister.this, "called1", Toast.LENGTH_LONG).show();

                                                                    String phonenumber = Cpp.getSelectedCountryCodeWithPlus() + mobile;
                                                                    Intent intent = new Intent(ChefRegister.this, ChefVerifyPhone.class);
                                                                    intent.putExtra("phonenumber", phonenumber);
                                                                    startActivity(intent);

                                                                  //  Toast.makeText(ChefRegister.this, "called22", Toast.LENGTH_LONG).show();
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ChefRegister.this, ChefLogin.class);
                startActivity(i);
        //        finish();
            }
        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(ChefRegister.this, ChefLoginPhone.class);
                startActivity(e);
           //     finish();
            }
        });
    ...
    private void init() {
        Fname = (TextInputLayout) findViewById(R.id.chef_Firstname);
        Lname = (TextInputLayout) findViewById(R.id.chef_lastname);
        Email = (TextInputLayout) findViewById(R.id.chef_email);
        Pass = (TextInputLayout) findViewById(R.id.chef_pwd);
        cfpass = (TextInputLayout) findViewById(R.id.chef_confirm_pass);
        mobileno = (TextInputLayout) findViewById(R.id.chef_Mobileno);
        houseno = (TextInputLayout) findViewById(R.id.chef_houseNo);
        area = (TextInputLayout) findViewById(R.id.chef_Area);
        postcode = (TextInputLayout) findViewById(R.id.chef_Postcode);
        statespin = (Spinner) findViewById(R.id.chef_State);
        Cityspin = (Spinner) findViewById(R.id.chef_Citys);
        Suburban = (Spinner) findViewById(R.id.chef_Suburban);
        signup = (Button) findViewById(R.id.chef_Signup_button);
        Emaill = (Button) findViewById(R.id.chef_email_button);
        Phone = (Button) findViewById(R.id.chef_phone);
        Cpp = (CountryCodePicker) findViewById(R.id.chef_CountryCode);
    }
}