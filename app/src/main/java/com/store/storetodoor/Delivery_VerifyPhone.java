...
public class Delivery_VerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entercode = (EditText) findViewById(R.id.phoneno_edittext_dvp);
        txt = (TextView) findViewById(R.id.text_dvp);
        Resend = (Button) findViewById(R.id.Resendotp_button_dvp);

        FAuth = FirebaseAuth.getInstance();
        verify = (Button) findViewById(R.id.Verify_button_dvp);
