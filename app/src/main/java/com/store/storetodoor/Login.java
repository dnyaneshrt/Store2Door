...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            email = (TextInputLayout) findViewById(R.id.cust_login_Lemail);
            pass = (TextInputLayout) findViewById(R.id.cust_login_Lpassword);

            Signout = (Button) findViewById(R.id.cust_Login_button);
            txt = (TextView) findViewById(R.id.cust_login_textView3);

            Forgotpassword=(TextView)findViewById(R.id.cust_login_forgotpass);
            SignInphone=(Button)findViewById(R.id.cust_login_btnphone);
