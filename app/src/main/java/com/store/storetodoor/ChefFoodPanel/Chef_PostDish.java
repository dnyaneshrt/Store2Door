package com.store.storetodoor.ChefFoodPanel;
...
import com.store.storetodoor.Chef;
...
public class Chef_PostDish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dishes = (Spinner) findViewById(R.id.dishes_cpd);
        desc = (TextInputLayout) findViewById(R.id.description_cpd);
        qty = (TextInputLayout) findViewById(R.id.quantity_cpd);
        pri = (TextInputLayout) findViewById(R.id.price_cpd);
        post_dish = (Button) findViewById(R.id.post_button_cpd);
            ...
            dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                  ...
                  //  Area=chefc.getArea();
                    ...
                    imageButton = (ImageButton) findViewById(R.id.imageupload_button_cpd);
...
//
//
//                                Toast.makeText(Chef_PostDish.this, "Uploaded", Toast.LENGTH_SHORT).show();
//                            } else
//                            {
//                                Toast.makeText(Chef_PostDish.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
//                            }
//                        }
//                    });
//                }
...
//
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    progressDialog.dismiss();
                    Log.e("image_error",e.getMessage().toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ((ImageButton) findViewById(R.id.imageupload_button_cpd)).setImageURI(result.getUri());
