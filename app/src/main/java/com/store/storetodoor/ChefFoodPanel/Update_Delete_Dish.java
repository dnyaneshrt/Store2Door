...
import com.store.storetodoor.ChefFoodPanel_BottomNavigation;
...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desc = (TextInputLayout) findViewById(R.id.description_audd);
        qty = (TextInputLayout) findViewById(R.id.quantity_audd);
        pri = (TextInputLayout) findViewById(R.id.price_audd);
        Dishname = (TextView) findViewById(R.id.dish_name_audd);
        imageButton = (ImageButton) findViewById(R.id.imageupload_audd);
        Update_dish = (Button) findViewById(R.id.Updatedish_audd);
        Delete_dish = (Button) findViewById(R.id.Deletedish_audd);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ((ImageButton) findViewById(R.id.imageupload_audd)).setImageURI(result.getUri());
