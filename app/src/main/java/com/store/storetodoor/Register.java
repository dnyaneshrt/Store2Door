...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            fname = (TextInputLayout) findViewById(R.id.cust_firstname);
            lname = (TextInputLayout) findViewById(R.id.cust_lastname);
            localadd = (TextInputLayout) findViewById(R.id.cust_Localaddress);
            emaill = (TextInputLayout) findViewById(R.id.cust_Emailid);

            pass = (TextInputLayout) findViewById(R.id.cust_Password);
            cmpass = (TextInputLayout) findViewById(R.id.cust_confirmpass);

            Signin = (Button) findViewById(R.id.cust_register_button);
            statespin = (Spinner) findViewById(R.id.cust_Statee);
            City = (Spinner) findViewById(R.id.cust_Citys);
            Suburban = (Spinner) findViewById(R.id.cust_Suburban);

            Mobileno = (TextInputLayout) findViewById(R.id.cust_Mobilenumber);
            Cpp = (CountryCodePicker) findViewById(R.id.cust_CountryCode);
            Email = (Button) findViewById(R.id.cust_emaill);
            Phone = (Button) findViewById(R.id.cust_phone);
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (cityy.equals("Mumbai")) {
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Register.this, android.R.layout.simple_spinner_item, listt);
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(Register.this, LoginPhone.class);
                startActivity(e);
            //    finish();
            }
        });
