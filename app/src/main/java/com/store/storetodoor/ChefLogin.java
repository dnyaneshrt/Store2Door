...
public class ChefLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            email = (TextInputLayout) findViewById(R.id.chef_Lemail);
            pass = (TextInputLayout) findViewById(R.id.chef_Lpassword);

            Signout = (Button) findViewById(R.id.chef_Login_button);
            txt = (TextView) findViewById(R.id.textView3);

            Forgotpassword = (TextView) findViewById(R.id.chef_forgotpass);
            Signinphone = (Button) findViewById(R.id.chef_lbtnphone);
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (FAuth.getCurrentUser().isEmailVerified()) {
                                        ...
                                        Intent intent = new Intent(ChefLogin.this, ChefFoodPanel_BottomNavigation.class);
            ...
            txt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent Register = new Intent(ChefLogin.this, ChefRegister.class);
