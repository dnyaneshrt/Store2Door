...
public class DeliveryRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      init();
        ...
        final ProgressDialog mDialog = new ProgressDialog(DeliveryRegister.this);
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Maharashtra")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(DeliveryRegister.this, android.R.layout.simple_spinner_item, list);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Mumbai")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(DeliveryRegister.this, android.R.layout.simple_spinner_item, listt);
                                        ...
                                        firebaseDatabase.getInstance().getReference("DeliveryPerson").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMappp).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(DeliveryRegister.this);
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(DeliveryRegister.this, Delivery_VerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(DeliveryRegister.this, "Error", task.getException().getMessage());
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(DeliveryRegister.this, DeliveryLoginPhone.class);
                startActivity(e);
             //   finish();
            }
        });
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(DeliveryRegister.this, DeliveryLogin.class);
                startActivity(a);
              //  finish();
            }
        });
    ...
    private void init() {
        ...
        Fname = (TextInputLayout) findViewById(R.id.delivery_fname);
        Lname = (TextInputLayout) findViewById(R.id.delivery_lname);
        Pass = (TextInputLayout) findViewById(R.id.delivery_password);
        Email = (TextInputLayout) findViewById(R.id.delivery_Emailid);
        cfpass = (TextInputLayout) findViewById(R.id.delivery_confirmpassword);

        mobileno = (TextInputLayout) findViewById(R.id.delivery_mobileno);
        houseno = (TextInputLayout) findViewById(R.id.delivery_Houseno);
        area = (TextInputLayout) findViewById(R.id.delivery_Areaa);
        postcode = (TextInputLayout) findViewById(R.id.delivery_Postcodee);
        statespin = (Spinner) findViewById(R.id.delivery_State);
        Cityspin = (Spinner) findViewById(R.id.delivery_City);
        Emaill = (Button) findViewById(R.id.delivery_emaillid);
        Suburban = (Spinner) findViewById(R.id.delivery_suburban);
        signup = (Button) findViewById(R.id.delivery_Signupp);
        Phone = (Button) findViewById(R.id.delivery_Phonenumber);
        Cpp = (CountryCodePicker) findViewById(R.id.delivery_ctrycode);
