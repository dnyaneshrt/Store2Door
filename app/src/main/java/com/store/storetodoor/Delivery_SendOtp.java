...
public class Delivery_SendOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entercode = (EditText) findViewById(R.id.phoneno_edittext_deotp);
        txt = (TextView) findViewById(R.id.text_deotp);
        Resend = (Button) findViewById(R.id.Resendotp_button_deotp);
        FAuth = FirebaseAuth.getInstance();
        Resend.setVisibility(View.INVISIBLE);
        txt.setVisibility(View.INVISIBLE);
        verify = (Button) findViewById(R.id.Verify_button_deotp);
