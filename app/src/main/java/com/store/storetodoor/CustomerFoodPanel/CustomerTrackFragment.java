...
public class CustomerTrackFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = v.findViewById(R.id.recyclefinalorders_fct);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        grandtotal = v.findViewById(R.id.Rs_fct);
        Address = v.findViewById(R.id.addresstrack_fct);
        Status=v.findViewById(R.id.status_fct);
        total = v.findViewById(R.id.btnn_fct);
