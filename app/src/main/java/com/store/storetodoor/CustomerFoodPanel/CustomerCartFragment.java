...
import com.store.storetodoor.ReusableCodeForAll;
import com.store.storetodoor.SendNotification.APIService;
import com.store.storetodoor.SendNotification.Client;
import com.store.storetodoor.SendNotification.Data;
import com.store.storetodoor.SendNotification.MyResponse;
import com.store.storetodoor.SendNotification.NotificationSender;
...
public class CustomerCartFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclecart = v.findViewById(R.id.recyclecart_fcc);
        ...
        grandt = v.findViewById(R.id.GT_fcc);
        remove = v.findViewById(R.id.RM_fcc);
        placeorder = v.findViewById(R.id.PO_fcc);
        TotalBtns = v.findViewById(R.id.TotalBtns_fcc);
